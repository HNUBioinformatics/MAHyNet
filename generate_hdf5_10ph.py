...
def seq_to_matrix(seq,seq_matrix,seq_order):
    ...
    for i in range(len(seq)):
        if ((seq[i] == 'A') | (seq[i] == 'a')):
            seq_matrix[seq_order, i, 0] = 0.116
            seq_matrix[seq_order, i, 1] = 0.188
            seq_matrix[seq_order, i, 2] = 0.069
            seq_matrix[seq_order, i, 3] = 0.002
            seq_matrix[seq_order, i, 4] = 0.051
            seq_matrix[seq_order, i, 5] = 0.11
            seq_matrix[seq_order, i, 6] = 0.353
            seq_matrix[seq_order, i, 7] = 0.092
            seq_matrix[seq_order, i, 8] = 0.002

        if ((seq[i] == 'C') | (seq[i] == 'c')):
            seq_matrix[seq_order, i, 0] = 0.14
            seq_matrix[seq_order, i, 1] = 0.282
            seq_matrix[seq_order, i, 2] = 0.09
            seq_matrix[seq_order, i, 3] = 0.002
            seq_matrix[seq_order, i, 4] = 0.034
            seq_matrix[seq_order, i, 5] = 0.09
            seq_matrix[seq_order, i, 6] = 0.26
            seq_matrix[seq_order, i, 7] = 0.087
            seq_matrix[seq_order, i, 8] = 0.014
            #seq_matrix[seq_order, i, 5] = 1
        if ((seq[i] == 'G') | (seq[i] == 'g')):
            seq_matrix[seq_order, i, 0] = 0.148
            seq_matrix[seq_order, i, 1] = 0.288
            seq_matrix[seq_order, i, 2] = 0.099
            seq_matrix[seq_order, i, 3] = 0.002
            seq_matrix[seq_order, i, 4] = 0.053
            seq_matrix[seq_order, i, 5] = 0.068
            seq_matrix[seq_order, i, 6] = 0.225
            seq_matrix[seq_order, i, 7] = 0.122
            seq_matrix[seq_order, i, 8] = 0.014
  
        if ((seq[i] == 'U') | (seq[i] == 'u')):
            seq_matrix[seq_order, i, 0] = 0.145
            seq_matrix[seq_order, i, 1] = 0.284
            seq_matrix[seq_order, i, 2] = 0.085
            seq_matrix[seq_order, i, 3] = 0.002
            seq_matrix[seq_order, i, 4] = 0.032
            seq_matrix[seq_order, i, 5] = 0.109
            seq_matrix[seq_order, i, 6] = 0.277
            seq_matrix[seq_order, i, 7] = 0.053
            seq_matrix[seq_order, i, 8] = 0.013
...
def generate_dataset_matrix(file_path):
    ...
    for allFileFa in filenames:
        ...
        #print(AllTem)
        output_dir = allFileFa.split(AllTem)[0].replace("motif_discovery", "HDF5li")
        #print(allFileFa+'#')
        #print(AllTem+'*')
        #print(output_dir+'%')
        SeqLen = 81
